...
from pragyan.core.func import progress_bar, video_metadata, screenshot, chk_user, progress_callback, prog_bar
...
import cv2
import random
from pragyan.core.mongo.db import set_session, remove_session
import string
...
if STRING:
    ...
    print("App imported from pragyan.")
else:
    pro = None
...
async def get_msg(userbot, sender, edit_id, msg_link, i, message):
    ...
    if 't.me/c/' in msg_link or 't.me/b/' in msg_link or 'tg://openmessage' in msg_link:
        ...
        if chat in saved_channel_ids:
            await app.edit_message_text(message.chat.id, edit_id, "Sorry! dude 😎 This channel is protected 🔐 by **Pragyan**")
            return
...
async def callback_query_handler(event):
    ...
    if event.data == b'setchat':
        ...
        await event.edit("Choose your preferred upload method:\n\n__**Note:** **SpyLib ⚡**, built on Telethon(base), by Pragyan still in beta.__", buttons=buttons)
