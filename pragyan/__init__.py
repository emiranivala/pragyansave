...
pro = Client("pragyanpandey", api_id=API_ID, api_hash=API_HASH, session_string=STRING)

sex = TelegramClient('pandeypragyan', API_ID, API_HASH).start(bot_token=BOT_TOKEN)
